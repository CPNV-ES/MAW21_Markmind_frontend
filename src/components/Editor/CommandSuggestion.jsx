...
export default function CommandSuggestion({ command, onSelect, onClose, position }) {
    const commands = [
    ...
    return (
        <ul style={{ position: 'absolute', left: `${position.x}px`, top: `${position.y}px`, opacity: 1 }} className={style.commandSuggestions}>
